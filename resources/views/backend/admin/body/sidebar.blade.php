@php
  ...
  $isStaffActive = Route::is('staff.*','admin.staff.index','admin.staff.create','admin.staff.show','admin.staff.edit','admin.staff.salary.index','admin.staff.salary.create','admin.staff.salary.edit','admin.staff.salary.show','admin.staff.salary.payment.index','admin.staff.salary.payment.create','admin.staff.salary.payment.edit','admin.staff.salary.payment.show');
@endphp
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item {{ $isTransactionsActive ? 'menu-open' : '' }}">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
                <a href="{{ route('project.advance.receipt.payment.index') }}" class="nav-link {{ Route::is('project.advance.receipt.payment.index','project.advance.receipt.payment.index') ? 'active' : '' }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Advance Receipt</p>
                </a>
            </li>
        ...
        <li class="nav-item {{ $isReportActive ? 'menu-open' : '' }}">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="{{ route('report.receipts.payments') }}" class="nav-link {{ Route::is('report.receipts.payments') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.staff.salary.payment.index') }}"
                        class="nav-link {{ Route::is('admin.staff.salary.payment.index') || Route::is('admin.staff.salary.payment.create') || Route::is('admin.staff.salary.payment.edit') || Route::is('admin.staff.salary.payment.show') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon"></i>
