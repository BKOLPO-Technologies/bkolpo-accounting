                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <select name="client" id="client"
                                                ...
                                                <option value="" disabled {{ old('client') ? '' : 'selected' }}>Select
                                                    Customer</option>
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                <button class="btn btn-danger" type="button" id="addClientBtn"
                                                    data-toggle="modal" data-target="#createClientModal">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-3">
                                        ...
                                        <input type="text" id="invoice_no" name="invoice_no"
                                            ...
                                            value="{{ old('invoice_no', $invoice_no) }}" readonly />
                                        @error('invoice_no')
                                            <div class="invalid-feedback">
                                                <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                            </div>
