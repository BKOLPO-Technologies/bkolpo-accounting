@extends('layouts.admin', ['pageTitle' => 'Quotation Edit'])
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="total_amount" name="total_amount"
                                                    value="{{ $quotation->total_amount }}" placeholder="Enter Total Amount">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" id="date" name="quotation_date" class="form-control"
                                        ...
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="description" name="description" rows="3"
                                                        placeholder="Enter description">{{ $quotation->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
