@extends('layouts.admin', ['pageTitle' => 'Advance Payment Receive List'])
@section('admin')
                        ...
                        <div class="card card-primary card-outline shadow-lg">
                            <div class="card-header py-2">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('project.advance.receipt.payment.create') }}"
                                        ...
                                        @foreach ($receipts as $key => $receipt)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <!-- View Button -->
                                                    <a href="{{ route('project.advance.receipt.payment.show', ['reference_no' => $receipt->reference_no]) }}"
                                                        class="btn btn-success btn-sm">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <!-- Edit Button -->
                                                    <a href="{{ route('project.advance.receipt.payment.edit', $receipt->id) }}"
                                                        class="btn btn-primary btn-sm">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="{{ route('project.advance.receipt.payment.destroy', $receipt->id) }}"
                        ...
                        <div style="padding:20px; border:1px solid #ccc; font-family:Arial, sans-serif; font-size:14px;">
                            ...
                            <div style="margin-top:20px;">
                                <table style="width:100%; border-collapse:collapse; text-align:center;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="border:1px solid #dee2e6; padding:6px;">
                                                {{ bdt() }} {{ number_format($receipt->receive_amount, 2) }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                <div>
                                    ...
                                    <strong>{{ convertNumberToWords($receipt->receive_amount) }}</strong>
                                </div>
