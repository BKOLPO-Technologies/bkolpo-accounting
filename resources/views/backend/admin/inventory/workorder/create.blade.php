@extends('layouts.admin', ['pageTitle' => 'Work Order Create'])
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" class="form-control" id="from_date" name="start_date" value="{{ old('start_date') }}" placeholder="Enter Start Date">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                <input type="date" class="form-control" id="to_date" name="end_date" value="{{ old('end_date') }}" placeholder="Enter End Date">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="remarks" name="remarks" rows="3" placeholder="Enter remarks">{{ old('remarks') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
