@extends('layouts.admin', ['pageTitle' => 'Contra Voucher Edit'])
@section('admin')
                        ...
                        <div class="card card-primary card-outline shadow-lg">
                            ...
                            <div class="card-header py-2">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('contra-voucher.index')}}" class="btn btn-sm btn-danger rounded-0">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('contra-voucher.update', $journal->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
