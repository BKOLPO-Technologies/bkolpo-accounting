@extends('layouts.admin', ['pageTitle' => 'Purchases Report'])
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline shadow-lg">
                        ...
                        <div class="card-body mt-3">
                            <!-- Date Filter Form -->
                            <form action="{{ route('report.purchases.sales') }}" method="GET" class="mb-3">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-1 mt-3 d-flex align-items-end">
                                        <a href="{{ route('report.purchases.sales') }}"  class="btn btn-danger w-100">Clear</a>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12 mx-auto">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <div id="amountInWordsPrint" style="margin-top: 10px;">
                                                ...
                                                <strong>{{ convertNumberToWords(number_format($purchasesSalesReports->sum('debit'), 2)) }}</strong>
                                            </div>
                                            {{-- <div id="amountInWordsPrint" style="margin-top: 10px;">
