@extends('layouts.admin', ['pageTitle' => 'Day Book Report'])
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline shadow-lg">
                        ...
                        <div class="card-body mt-3">
                            <!-- Date Filter Form -->
                            <form action="{{ route('report.daybook') }}" method="GET" class="mb-3">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-1 mt-3 d-flex align-items-end">
                                        <a href="{{ route('report.daybook') }}"  class="btn btn-danger w-100">Clear</a>
                                    </div>
                                </div>
                            </form>
                                        ...
                                        <div class="table-responsive">
                                           <table id="example3" class="table-striped table-bordered" style="width: 100%;">
                                            ...
                                            <div id="amountInWordsPrint" style="margin-top: 10px;">
                                                ...
                                                <strong>{{ convertNumberToWords(number_format(abs($running_balance), 2)) }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
