@extends('layouts.admin', ['pageTitle' => 'Bills Receivable Report'])
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline shadow-lg">
                        ...
                        <div class="card-body mt-3">
                            <!-- Date Filter Form -->
                            <form action="{{ route('report.bills.receivable') }}" method="GET" class="mb-3">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-1 mt-3 d-flex align-items-end">
                                        <a href="{{ route('report.bills.receivable') }}"  class="btn btn-danger w-100">Clear</a>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12 mx-auto">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <div id="amountInWordsPrint" style="margin-top: 10px;">
                                                ...
                                                <strong>{{ convertNumberToWords(number_format($billsReceivableReports->sum('grand_total'), 2)) }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    $(win.document.body).prepend(`
                        <div class="text-center mb-2" style="margin-bottom: 10px;">
                            <h2 style="margin: 5px 0; font-size: 18px;">
                                <img 
                                    src="{{ !empty(get_company()->logo) ? url('upload/backend/company/' . get_company()->logo) : asset('backend/logo.jpg') }}" 
                                    alt="Company Logo" 
