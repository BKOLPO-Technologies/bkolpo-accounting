...
@section('admin')
    <style>
        ...
        .welcome-message {
            ...
            position: absolute;
            top: 10%;
            /* Position the message near the top */
                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-info">
                            <div class="inner">
                                <h3>{{ number_format($projectTotalAmount, 2) }}</h3>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-success">
                            <div class="inner">
                                <h3>{{ number_format($projectTotalAmountPaid, 2) }}</h3>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-danger">
                            <div class="inner">
                                <h3>{{ number_format($projectTotalAmountDue, 2) }}</h3>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-warning">
                            <div class="inner">
                                <h3>{{ number_format($purchaseTotalAmount, 2) }}</h3>
                                <p>Purchase Total</p>
                            </div>
                            <div class="icon">
                                <i class="fas fa-tasks"></i>
                            </div>
                            <a href="{{ route('admin.purchase.order.index') }}" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var pieData = {
                ...
                datasets: [{
                    data: [projectTotalAmount, projectTotalAmountPaid, projectTotalAmountDue,
                        purchaseTotalAmount
                    ],
