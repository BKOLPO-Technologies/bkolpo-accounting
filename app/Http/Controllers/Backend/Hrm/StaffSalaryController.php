...
class StaffSalaryController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        // Get staff whose salary is not fully paid for the selected month
        ...
        return view('backend.admin.hrm.salary.create', compact('pageTitle', 'staffs', 'ledgers'));
    }
