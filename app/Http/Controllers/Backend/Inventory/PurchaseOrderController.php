...
class PurchaseOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        //dd($purchases);
        return view('backend.admin.inventory.purchase.order.index',compact('pageTitle','purchases'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.admin.inventory.purchase.order.create', compact(
            'pageTitle', 
            'suppliers', 
            'products',
            'categories',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.purchase.order.index')->with('success', 'Purchase created successfully!');
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function show(Request $request)
    {
        ...
        return view('backend.admin.inventory.purchase.order.view_modal_part', compact('purchase', 'payments'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('backend.admin.inventory.purchase.order.edit', [
            'pageTitle' => $pageTitle, 
            'purchase' => $purchase, 
            'suppliers' => $suppliers, 
            'aproducts' => $aproducts,
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.purchase.order.index')->with('success', 'Purchase updated successfully!');
        } catch (\Exception $e) {
            DB::rollback();
            return back()->withErrors(['error' => 'Something went wrong! Please try again.']);
        }
